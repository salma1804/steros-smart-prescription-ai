contenu = '''from rapidfuzz import fuzz, process
...
with open("moteur_nlp.py", "w", encoding="utf-8") as f:
    f.write(contenu)

print("moteur_nlp.py régénéré avec succès, sans risque de corruption.")
